...
void c_monster::init(int t)
{
	...
	case 9:wcscpy_s(name,L"骷髅人");position=8;break;
	case 10:wcscpy_s(name,L"骷髅士兵");position=9;break;
	case 11:wcscpy_s(name,L"骷髅队长");position=10;break;
	case 12:wcscpy_s(name,L"冥队长");position=11;break;
	case 13:wcscpy_s(name,L"兽人");position=12;break;
	case 14:wcscpy_s(name,L"兽面武士");position=13;break;
	case 15:wcscpy_s(name,L"石头人");position=14;break;
	case 16:wcscpy_s(name,L"影子战士");position=15;break;
	case 17:wcscpy_s(name,L"初级法师");position=16;break;
	case 18:wcscpy_s(name,L"高级法师");position=17;break;
	case 19:wcscpy_s(name,L"初级巫师");position=18;break;
	case 20:wcscpy_s(name,L"高级巫师");position=19;break;
	...
	case 26:wcscpy_s(name,L"金骑士");position=25;break;
	case 27:wcscpy_s(name,L"红骑士");position=26;break;
	case 28:wcscpy_s(name,L"黑骑士");position=27;break;
	case 29:wcscpy_s(name,L"黑衣魔王");position=28;break;
	case 30:wcscpy_s(name,L"黄衣魔王");position=29;break;
	case 31:wcscpy_s(name,L"青衣武士");position=30;break;
	case 32:wcscpy_s(name,L"蓝骑士");position=31;break;
	case 33:wcscpy_s(name,L"黄头怪");position=32;break;
	case 34:wcscpy_s(name,L"紫骷髅");position=33;break;
	case 35:wcscpy_s(name,L"紫蝙蝠");position=34;break;
	case 36:wcscpy_s(name,L"铁面人");position=35;break;
	case 99:wcscpy_s(name,L"黑衣魔王");position=28;break;
	default:position=-1;
	}
	if (position!=-1) {
		hp=consts.monster_map[200+id][0];
		atk=consts.monster_map[200+id][1];
		def=consts.monster_map[200+id][2];
		money=consts.monster_map[200+id][3];
		special=consts.monster_map[200+id][4];
		for(int i=0;i<4;i++)
			monster[i]=new hgeSprite(consts.ht_monster,32*(i/2),32*position,32,32);
	}
